	...
	<body>
		...
		<div class="img_background centralizarCorpo">
			...
			<div class="title_curriculo">
				<span class="name">Rafael Bueno</span><br />
				<span class="job">System Engineer</span>
			</div>

			<div class="detalhes detalhesPos">
				<span class="gmail">raf.bueno@gmail.com</span><br />
				<span class="hotmail">rbueno@hotmail.com</span><br />
				<span class="twitter">@rafbueno</span>
			</div>
